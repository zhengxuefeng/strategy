...
public class AddressItem implements org.apache.thrift.TBase<AddressItem, AddressItem._Fields>, java.io.Serializable, Cloneable, Comparable<AddressItem> {
  ...
  public void validate() throws TException {
    ...
    if (addressId == null) {
      throw new TProtocolException("Required field 'addressId' was not present! Struct: " + toString());
    }
    if (lat == null) {
  ...
  private static class AddressItemStandardScheme extends StandardScheme<AddressItem> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, AddressItem struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddressItem struct) throws TException {
      struct.validate();
  ...
  private static class AddressItemTupleScheme extends TupleScheme<AddressItem> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddressItem struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddressItem struct) throws TException {
